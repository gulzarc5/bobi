                ...
                <div>
                    <div class="x_content">
                        @if(isset($slider_edit) && !empty($slider_edit))
                            {{Form::model($slider_edit, ['method' => 'post','route'=>'admin.app_slider_update','enctype'=>'multipart/form-data'])}}
                            {{ Form::hidden('id',null,array('class' => 'form-control','placeholder'=>'Enter Category name')) }}
                        @else
                            {{ Form::open(['method' => 'post','route'=>'admin.app_slider_insert','enctype'=>'multipart/form-data']) }}
                        @endif
                        ...
                        <div class="form-group">
                            @if(isset($slider_edit) && !empty($slider_edit))
                                ...
                                <a href="{{ route('admin.app_slider_form') }}" class="btn btn-warning">Back</a>
                            @else
