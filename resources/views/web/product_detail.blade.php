        ...
        <div class="col-main">
          <div class="product-view-area">
            <div class="product-big-image col-xs-12 col-sm-5 col-lg-5 col-md-5">
              ...
              <div class="large-image"> <a href="{{asset('web/images/products/img01.jpg')}}" class="cloud-zoom" id="magni_img" data-big="{{asset('web/images/products/img01.jpg')}}" data-overlay="{{asset('web/images/magnifying_glass.png')}}" rel="useWrapper: false, adjustY:0, adjustX:20"> <img  src="{{asset('web/images/products/img01.jpg')}}" alt="pr img"/></a> </div>
            ...
            <div class="col-xs-12 col-sm-7 col-lg-7 col-md-7 product-details-area">
              <div class="product-name">
                <h1>Anouk-Men Maroon & Beige Printed Straight Short Kurta</h1>
              </div>
              <div class="price-box">
