            ...
            <div class="panel panel-default panel-table">
                        ...
                        <div class="panel-body">
                           <div class="tr">
                              ...
                              <div class="td">Returns Window, Actions Possible and Conditions (if any)</div>
                           </div>
                        </div>
                        <div class="panel-body">
                           <div class="tr">
                              <div class="td">Lifestyle: Clothing, Footwear, Watches, Sunglasses, Fashion Accessories</div>
                              <div class="td">2 days<br>
                        ...
                        <div class="panel-body">
                           <div class="tr">
                              <div class="td">Lifestyle: Sport & Fitness Equipment,, Baby Care, Jewellery, Footwear Accessories, Travel Accessories, Lingerie (top-wear) <br>
                              ...
                              Automotive: All automotive spare parts, accessories </div>
                              <div class="td">5 days<br>
                        ...
                        <div class="panel-body">
                           <div class="tr">
                              <div class="td">All Electronics, Furniture and Large appliances other than Apple / Beats and Google Products</div>
                              <div class="td">5 days<br>
                                Replacement only<br>
                        ...
                        <div class="panel-body">
                           <div class="tr">
                              <div class="td">No Returns categories </div>
                              <div class="td">No Returns categories   Some products in the above categories are not returnable due to their nature or other reasons. For all products, the policy on the product page shall prevail.<br> 
